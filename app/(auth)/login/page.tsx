      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-[#09090b]">
        ...
        >
          <motion.div variants={itemVariants} className="mb-10 text-center lg:text-left">
            ...
            <p className="text-[#a1a1aa] mt-2 text-sm">Enter your details to access your account.</p>
          </motion.div>

          {/* Social Logins (Outline, Monochrome) */}
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4 mb-8">
            <button className="flex items-center justify-center gap-2 h-11 px-4 rounded-md border border-[rgba(255,255,255,0.15)] bg-transparent text-sm font-medium text-white hover:bg-white/5 hover:border-[rgba(255,255,255,0.3)] transition-all">
          ...
          {errorMsg && (
            <motion.div variants={itemVariants} className="mb-6 p-3 rounded-md bg-red-500/10 border border-red-500/20 text-red-400 text-sm">
              {errorMsg}
            </motion.div>
          )}
          ...
          <motion.form variants={itemVariants} onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label htmlFor="account" className="block text-sm font-medium text-[#a1a1aa]">
                Username or Email
              </label>
              <input
                id="account"
