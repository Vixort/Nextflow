...
-- Massive 14-section Home page payload & full-bleed background imagery
-- ====================================================================
...
INSERT INTO public.website_templates (
  ...
  'Luxury minimalist real estate & villa design studio template featuring full-bleed background imagery, warm bone white aesthetics, serif monograph typography, estate listing specs, bespoke horizontal image rail, 4 full pages (Home, Estates Directory, Atelier Services, Private Inquiry), and offline ZIP export support.',
      ...
      jsonb_build_object(
        ...
        'data', jsonb_build_object(
          'content', jsonb_build_array(
            ...
            jsonb_build_object('id', 'quote-lumina-estates', 'type', 'EstatePhilosophyQuote', 'props', jsonb_build_object('quote', '"To create architecture is to put in order. Put what in order? Function and objects."', 'author', 'LUMINA ARCHITECTURAL PRINCIPLES', 'monograph', 'GLOBAL VILLA PORTFOLIO 2026', 'bgImg', 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=1600&auto=format&fit=crop&q=80')),
            ...
            jsonb_build_object('id', 'comparison-lumina-estates', 'type', 'FeatureComparisonGrid', 'props', jsonb_build_object('title', 'Villa Structural Comparison', 'col1Name', 'Monograph Alpine Villa', 'col2Name', 'Coastal Glass Pavilion', 'row1', 'Triple-Glazed Acoustic Glass Panels', 'row2', 'Zero-Carbon Solar Roof Integration', 'row3', 'Private Waterfront / Helipad Dock')),
      ...
      jsonb_build_object(
        ...
        'data', jsonb_build_object(
          'content', jsonb_build_array(
            ...
            jsonb_build_object('id', 'timeline-lumina-services', 'type', 'EstateArchitecturalTimeline', 'props', jsonb_build_object('title', 'Chronological Execution Monograph', 'subtitle', 'Our 4-phase architectural process from raw land intake to structural commission handover.', 'step1Title', '01. Land & Topography Mapping', 'step1Desc', 'Sub-centimeter drone LIDAR topography scanning and sun-path light analysis.', 'step2Title', '02. Spatial Proportion & VR', 'step2Desc', 'Golden-ratio spatial blueprint modeling with 1:1 scale virtual reality walkthroughs.', 'step3Title', '03. Authentic Material Quarrying', 'step3Desc', 'Direct quarrying of Italian travertine stone and triple-glazed panoramic acoustic glass.', 'step4Title', '04. Off-Grid Solar Envelope', 'step4Desc', 'Integration of zero-carbon solar roofs, smart automation, and final atelier sign-off.')),
