...
INSERT INTO public.website_templates (
  ...
  'Luxury minimalist real estate & villa design studio template featuring warm bone white aesthetics, serif typography, estate listing specs, 4 full pages (Home, Estates Directory, Atelier Services, Private Inquiry), and offline ZIP export support.',
